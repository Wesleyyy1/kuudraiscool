...
import {checkApiKey, delay, kicPrefix, setRegisters} from "./utils/generalUtils.js";
...
const commands = [
    ...
    { text: "&8* &a .cata [player]\n\n", hover: `&a&lCata Info\n\n&9Party &8> &b[MVP&0+&b] ${playername}&f: .cata Wesleygame\n&9Party &8> &b[MVP&0+&b] ${playername}&f: &rWesleygame's Cata: 48.77 - PB: 05:37:20 - MP: 1404 - Secrets: 28.51K&r` },
